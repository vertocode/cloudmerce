<template>
  ...
  >
    <div class="add-item-question-modal">
      ...
      <VRow dense v-if="product?.fields?.length">
        <VCol
            cols="12"
    ...
    <VRow align="center" justify="space-between">
      <VCol cols="6" md="6">
        <v-btn class="w-100 close-btn" @click="$emit('close')">Fechar</v-btn>
      </VCol>
      <VCol cols="6" md="6">
        <v-btn class="w-100 confirm-btn" color="primary" :loading="loading" @click="handleConfirm">Confirmar</v-btn>
      </VCol>
    </VRow>
  </ElModal>
</template>
